...
public final class FlightRouteDaoImpl extends AbstractDao<Integer, FlightRoute> implements FlightRouteDao {
    ...
    public void updateEntity(final FlightRoute entity) {
        ...
        getSession().createSQLQuery("UPDATE flight_route SET first_class_price = " + first + ", business_class_price = "
                + business + ", economy_class_price = " + economy + " WHERE id = " + id).executeUpdate();
    }
}
